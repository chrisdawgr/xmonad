...
myWorkspaces =
  [
    "1:Docs",  "2:Dev", "3:Web", "4:Term"
  ]


startupWorkspace = "1:Docs"  -- which workspace do you want to be on after launch?
...
myKeyBindings =
  [
    ...
    , ((myModMask, xK_o), spawn "nautilus")
    , ((myModMask, xK_c), spawn "google-chrome")
    , ((myModMask, xK_g), spawn "evince")
    , ((myModMask, xK_t), spawn "texmaker")
    , ((myModMask, xK_m), spawn "matlab")
    , ((myModMask .|. shiftMask, xK_space), spawn "terminator")
...
myStartupHook :: X ()
myStartupHook = do 
  spawnOn "4:Docs" "chromium-browser"
  spawnOn "5:Dev" "terminator"
-}
main = do
...
xmobarPP { 
                  ppOrder               = \(ws:l:t:_)   -> [ws]
                , ppCurrent             = xmobarColor   myCurrentWSColor       myCurrentWSColor
                , ppUrgent              = xmobarColor   myCurrentWSColor      myCurrentWSColor
                , ppVisible             = xmobarColor   myCurrentWSColor       myCurrentWSColor
                , ppHidden              = xmobarColor   myCurrentWSColor      myCurrentWSColor
                , ppHiddenNoWindows     = xmobarColor   myCurrentWSColor       myCurrentWSColor
                , ppWsSep               = ""
                , ppSep                 = ""
                }
-}